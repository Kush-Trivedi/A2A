...
from ace_agent_kit import DelegationTarget, PromptStore
...
class AgentConfig:
    ...
    prompt_store: PromptStore = field(default_factory=lambda: PromptStore({}))
...
def get_agent_config() -> AgentConfig:
    ...
    return AgentConfig(
        ...
        prompt_store=PromptStore.from_manifest(manifest.get("prompts")),
        llm_deployments={
            str(k): str(v) for k, v in (manifest.get("llm", {}) or {}).items() if v
        },
