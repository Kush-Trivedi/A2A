"""Contract Negotiations Assistant — live Unity Catalog answers for the
supply chain team.

Same shape as the GDA agent: no data credentials, every question goes
through aubrey's /capability/data/genie with the team token scoped to
this team's registered connection, Genie conversation continuity is
platform-managed per chat session, and the manifest owns every prompt."""
